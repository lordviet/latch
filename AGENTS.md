...
- Favor deterministic scripts for building and bundling the app.
...
3. Refactor clipboard entries to support multiple content types.
4. Add image capture, preview, pinning, and restore behavior.
